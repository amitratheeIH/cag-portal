...
export const metadata: Metadata = { title: 'Audit Impact — CAG Digital Repository' }
  ...
  return (
    <main id="main-content" style={{ maxWidth:'900px', margin:'0 auto', padding:'60px 20px' }}>
      ...
      <p style={{ fontFamily:'system-ui', fontSize:'14px', color:'var(--ink3)', margin:'0 0 40px', lineHeight:1.6 }}>
        Reports on recoveries, savings, and systemic impact of audit
      </p>
      ...
      <div style={{
        ...
        <p style={{ fontFamily:'system-ui', fontSize:'13px', color:'var(--ink3)', margin:'0 0 24px', maxWidth:'400px', marginLeft:'auto', marginRight:'auto' }}>
          This section is under development. Audit Impact will be available here once the ingest pipeline is extended to cover this report category.
        </p>
        <Link href="/" style={{
